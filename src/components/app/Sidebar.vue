...
<template>
  ...
  >
    <perfect-scrollbar
      ...
      v-bind:class="{ 'h-100': appOption.appSidebarFixed }"
    >
      <div class="menu">
        <div class="menu-profile">
          <a
            ...
            v-on:click="appSidebarProfileToggle($event)"
          >
        ...
        <div class="menu-item d-flex">
          <a
            ...
            v-on:click="toggleAppSidebarMinified($event)"
  ...
  <div class="app-sidebar-mobile-backdrop">
    <a href="#" v-on:click="appSidebarMobileToggled" class="stretched-link"></a>
  </div>
</template>
